...
public record DebtorContactResponseDto(
    ...
    @Schema(
        description = "Notification channel. One of: EMAIL.",
        example = "EMAIL",
        nullable = false)
    ...
    @Schema(
        description = "Dispatch priority within the same (debtor, contactType) group. Lower value = higher priority. 1 is the primary contact.",
        example = "1",
        nullable = false)
    Integer priority,
