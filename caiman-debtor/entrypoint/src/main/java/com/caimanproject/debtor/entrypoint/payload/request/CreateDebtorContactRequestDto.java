...
@Schema(
        description =
                "A single contact endpoint for a debtor, identifying both the channel and the address used by the notification dispatcher.")
@Builder
@ValidContactValue
public record CreateDebtorContactRequestDto(
        ...
        @Schema(
                description =
                        "The actual contact address for the given contactType. EMAIL — standard email address (e.g. user@example.com).",
