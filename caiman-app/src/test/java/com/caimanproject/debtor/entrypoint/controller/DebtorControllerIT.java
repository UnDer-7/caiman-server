    ...
    class CreateDebtor {
        ...
        void should_return_400_when_name_is_blank() {
            ...
            webTestClient
                    ...
                    .jsonPath("$.detail")
                    .isEqualTo("One or more request fields are invalid. See errors for details.")
                    .jsonPath("$.instance")
                    .exists()
                    ...
                    .isEqualTo(channel)
                    .jsonPath("$.errors")
                    .value(List.class, errors -> assertThat(errors).hasSize(1))
                    .jsonPath("$.errors[0].code")
                    .isEqualTo("WEB_SUPPORT_002")
                    .jsonPath("$.errors[0].message")
                    .isEqualTo("Some invalid values were sent")
                    .jsonPath("$.errors[0].detail")
                    .isEqualTo("must not be blank")
                    .jsonPath("$.errors[0].source.body")
                    .isEqualTo("$.name");
        }
        ...
        void should_return_422_when_contacts_have_duplicate_value() {
            ...
            webTestClient
                    ...
                    .jsonPath("$.detail")
                    .isEqualTo("One or more business rules were violated. See errors for details.")
                    .jsonPath("$.instance")
                    .exists()
                    .jsonPath("$.correlationId")
                    .isEqualTo(correlationId)
                    ...
                    .value(List.class, errors -> assertThat(errors).hasSize(1))
                    .jsonPath("$.errors[0].code")
                    .isEqualTo("DEBTOR_BUSINESS_001")
                    .jsonPath("$.errors[0].message")
                    .isEqualTo("Informed contact list has duplicate contact value")
                    .jsonPath("$.errors[0].detail")
                    .isEqualTo("contactType: EMAIL - priority: 1")
                    .jsonPath("$.errors[0].source.body")
                    .isEqualTo("$.contacts[*].contactValue")
                    .jsonPath("$.errors[0].source.invalidValue")
                    .isEqualTo(duplicateContactValue);
        }
        ...
        void should_return_422_when_contacts_have_duplicate_priority() {
            ...
            webTestClient
                    ...
                    .value(List.class, errors -> assertThat(errors).hasSize(1))
                    .jsonPath("$.errors[0].code")
                    .isEqualTo("DEBTOR_BUSINESS_002")
                    .jsonPath("$.errors[0].message")
                    .isEqualTo("Informed contact list has duplicate contact priority")
                    .jsonPath("$.errors[0].detail")
                    .isEqualTo("contactType: EMAIL - contactValue: johndoe@example.com")
                    .jsonPath("$.errors[0].source.body")
                    .isEqualTo("$.contacts[*].priority")
                    .jsonPath("$.errors[0].source.invalidValue")
                    .isEqualTo(String.valueOf(duplicatePriority));
        }
        ...
        void should_return_400_when_contact_value_is_invalid_email(final String invalidEmail) {
            ...
            webTestClient
                    ...
                    .jsonPath("$.errors[0].source.body")
                    .isEqualTo("$.contacts[0].contactValue");
        }
        ...
        void should_return_400_when_required_headers_are_missing() {
            ...
            webTestClient
                    ...
                    .doesNotExist()
                    .jsonPath("$.errors")
                    .value(List.class, errors -> assertThat(errors).hasSize(2))
                    .jsonPath("$.errors[0].code")
                    .isEqualTo("WEB_SUPPORT_002")
                    .jsonPath("$.errors[0].message")
                    .isEqualTo("Some invalid values were sent")
                    .jsonPath("$.errors[0].detail")
                    .isEqualTo("Required field is null/blank")
                    .jsonPath("$.errors[1].code")
                    .isEqualTo("WEB_SUPPORT_002")
                    .jsonPath("$.errors[1].message")
                    .isEqualTo("Some invalid values were sent")
                    .jsonPath("$.errors[1].detail")
                    .isEqualTo("Required field is null/blank")
                    ...
                    .value(
                            ...
                            headers -> assertThat(headers)
                                    .containsExactlyInAnyOrder(
                                            RequestConstants.Headers.X_CORRELATION_ID,
